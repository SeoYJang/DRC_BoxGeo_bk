...
do
    ...
    tower_material="TB2024"

    macroname="${tower_material}_${i:0:-1}_zero"
    ...
    do
        ...
        root_name="${macroname}_${j}GeV"

        ########################################################
        results="/u/user/syjang/scratch/DRC_generic/results/TB2024/$root_name/"
        ################################^^^^^^^^################
        ...
        # ---------------------------
        # ---------------------------
        # for Cneter of Module (theta 1.5) TB2024
        # theta : 1.5
        # phi   : 1.0
        # x(cm) : -6.403
        # y(cm) : 5.093
        ...
        echo "/DRsim/generator/x0 -2.5" >> 1run_$macroname.mac
        echo "/DRsim/generator/y0 2.5" >> 1run_$macroname.mac
